            ...
            <FieldSet>
              ...
              <Field>
                ...
                <Textarea
                  ...
                  rows={3}
                  class="border border-neutral-300 dark:border-neutral-600 p-1.5 rounded-lg"
                />
              </Field>
            ...
            : (
              <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3">
                {items.map((item) => (
                  <div
                    key={item.id}
                    class="flex flex-col gap-2 border border-neutral-200 dark:border-neutral-700 rounded-lg p-3"
                  >
                          ...
                          {PREVIEWABLE_TYPES.includes(item.type)
                            ...
                            : (
                              <a
                                ...
                                target="_blank"
                                rel="noreferrer"
                                class="h-32 w-full flex items-center justify-center rounded bg-neutral-100 dark:bg-neutral-800 text-xs uppercase text-neutral-500 truncate px-2"
                              >
                                {item.type}
                              </a>
                            )}
