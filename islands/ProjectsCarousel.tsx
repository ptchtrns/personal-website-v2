      ...
      <DialogContent class="max-w-3xl gap-6">
        ...
        <div class="flex flex-col gap-3">
          ...
          {project.descriptionHtml && (
            <div
              class="markdown-content text-neutral-700 dark:text-neutral-300"
            ...
            >
              <Card class="relative overflow-hidden py-0 gap-0 h-full hover:opacity-90 transition-opacity">
                {project.isPinned && (
                  <FaIcon
                    icon={faThumbtack}
                    class="absolute top-2 right-2 z-10 text-neutral-100 drop-shadow"
                  />
                )}
                {image
                  ? (
                  ...
                  : (
                    <div class="w-full aspect-video flex items-center justify-center bg-neutral-100 dark:bg-neutral-800 text-neutral-400">
