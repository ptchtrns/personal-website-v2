...
- Follow existing project structure
  ...
  - Do server-side-rendering, minimize client-side JavaScript and fetch() requests, unless not practical
...
- If appropriate, suggest user to commit the changes with suggested commit message
